...
contextBridge.exposeInMainWorld('electronAPI', {
    ...
    onAlwaysOnTopChanged: (callback) => ipcRenderer.on('view-always-on-top-changed', callback),
    onFullscreenChanged: (callback) => ipcRenderer.on('view-fullscreen-changed', callback),
