...
python -m pip install kivymd==1.1.1 pillow==10.1.0 pywin32==306 psutil==5.9.6 pyperclip==1.8.2 send2trash==1.8.3 pyinstaller==6.2.0
...
if %errorlevel% neq 0 (
    ...
    python -m pip install kivy kivymd pillow pywin32 psutil pyperclip send2trash pyinstaller
